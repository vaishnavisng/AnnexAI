...
import { fetchSummary, getDownloadUrl, type SummaryData } from "@/lib/api";
...
function SummaryContent() {
  ...
  return (
    <>
      <VideoBackground />
      <PageTransition label="Generating summary..." />
      ...
      <main ref={shellRef} className="chat-shell notes-shell docs-shell">
        <header className="chat-header">
          ...
          <div className="chat-meta">
            ...
            <Link className="pill" href={`/notes?${q(lectureId)}`}>Notes</Link>
        ...
        <section className="doc-toolbar">
          <div className="doc-title-group">
            <p className="doc-kicker">Quick revision view</p>
            <h2 className="doc-heading">Lecture Summary</h2>
          ...
          <div className="doc-actions">
            <a
              ...
              href={getDownloadUrl("summary", lectureId)}
              target="_blank"
